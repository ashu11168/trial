...
TimerInterruptHandler(int dummy)
{
    ...
    if (interrupt->getStatus() != IdleMode) {
        ...
        //here we add the condition of yielding on timer interrupt , only on linux and round robin
        if(scheduling_algorithm_number == ROUND_ROBIN || scheduling_algorithm_number == UNIX)
        {
